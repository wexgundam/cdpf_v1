        ...
        <form role="form" id="resouceForm" name="resouceForm" class="form-horizontal"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group input-xlarge">
                            <input id="parentId" type="hidden" name="parentId" value="${sysResource.parentId}">
                            <input id="parentName" type="text" name="parentName" readonly="readonly" class="form-control" placeholder="" value="${sysResource.parentName}">
                            <span class="input-group-btn">
								<button type="button" class="btn btn-primary" onclick="javascript:showSelTree()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="url" type="text" name="url" class="form-control input-inline  input-xlarge"
                               placeholder="" value=""><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group input-xlarge">
                            <input id="iconImg" type="text" name="iconImg" class="form-control" placeholder="" value="">
                            <span class="input-group-btn">
								<button type="button" class="btn btn-primary" onclick="javascript:showIcon()">
									<i class="fa fa-search"/></i> 选择
								</button>
							</span>
                        </div>
