...
public class SysUserDao extends BaseDao<SysUser, SysUserSearchVO> {
    ...
    public SysUser get(int id) {
        String sql = "select t.id,t.id,t.username,t.password,t.randomcode,t.status,t.realname,t.mobile,t.avatar,t.created_at,t.created_by,t.role_id,t.last_modified_by,t.last_modified_at from t_sys_user t where id=?";
        return get(sql, id);
    }
