...
public class GlobalCode {
    public static final String SAVE_SUCCESS = "10001";//保存成功
    public static final String DELETE_SUCCESS = "10002";//删除成功
    public static final String OPERA_SUCCESS = "10003";//操作成功
    public static final String AUDIT_SUCCESS = "10004";//审核成功
